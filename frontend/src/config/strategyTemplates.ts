 ...
 * 特征：
 * 1. T-1 日非涨停（涨幅<9.8%）
 * 2. T-10 至 T（含）至少 5 日结构日：收盘>昨收、收盘>开盘（阳线实体）、收盘在 5 日线上方
 * 3. 计入结构当日满足 5 日线 > 10 日线 > 20 日线
 * 4. 计入结构日中至少一半满足 5/10 日线斜率均向上
...
export const mainForceBuildPositionStrategy: StrategyTemplate = {
  ...
  name: '主力建仓',
  description:
    'T-1日涨幅<9.8%；T-10至T日（含）至少5日结构日：收盘>昨收、收盘>开盘、收盘站上5日线且5>10>20，且结构日中至少一半满足5/10日线斜率向上。T日涨停仅作打标供前端筛选。',
  timeRange: 120,
